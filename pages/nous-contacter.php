<html lang="fr-FR">
    <head>
        ...
        <script src="../js/nous-contacter.js"></script>
    </head>
    <body>
        <?php include('../includes/header.html.inc.php'); ?>
        <h1>Nous localiser :</h1>
        <article id="geoloc">
			<img src="http://maps.googleapis.com/maps/api/staticmap?size=290x290&markers=icon:http://goo.gl/NbWy0j|Orl%C3%A9ans&zoom=11&key=AIzaSyDh9KulsuezlL3J8OEcuq2u-wLHb2MH3S8" alt="Carte Google Maps statique avec emplacement de Nolark" />
            <img src="http://maps.googleapis.com/maps/api/staticmap?size=290x290&markers=icon:http://goo.gl/NbWy0j|F%C3%A8s,+Maroc&zoom=11&key=AIzaSyDh9KulsuezlL3J8OEcuq2u-wLHb2MH3S8" alt="Carte Google Maps statique avec emplacement de Nolark" />
            <img src="http://maps.googleapis.com/maps/api/staticmap?size=290x290&markers=icon:http://goo.gl/NbWy0j|Toulon&zoom=11&key=AIzaSyDh9KulsuezlL3J8OEcuq2u-wLHb2MH3S8" alt="Carte Google Maps statique avec emplacement de Nolark" />
        <img id="streetview" src="https://maps.googleapis.com/maps/api/streetview?size=640x400&location=43.1212582,5.9405575&heading=234.44&pitch=15&fov=100&key=AIzaSyDh9KulsuezlL3J8OEcuq2u-wLHb2MH3S8" />
        </article>
        <br />
        ...
        <section id="formulaire">
            <form id="form_contact" name="form_contact" action="http://btssio.bonaparte.free.fr/testforms.php">
                <fieldset id="coordo">
                    ...
                    <p><label for="i_nom">Votre nom :</label> <input type="text" name="i_nom" id="i_nom" size="35" /></p>
                    <p><label for="i_prenom">Votre prénom :</label> <input type="text" name="i_prenom" id="i_prenom" size="35" /></p>
                    <p><label for="i_email">Votre e-mail :</label> <input type="email" name="i_email" id="i_email" size="35" /></p>
                    <p><label for="i_url">Votre url :</label> <input type="url" name="i_url" id="i_url" size="35" /></p>
                    <p>
                    ...
                    <p>
                        ...
                        <input type="number" name="num_jour" id="num_jour" min="1" max="31" /> / <input type="number" name="num_mois" id="num_mois" min="1" max="12" /> / <input type="number" name="num_annee" id="num_annee" min="1900" max="2013" />
                    </p>
                    <fieldset id="marques">
                        ...
                        <table width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox" name="chk_marques[]" id="chk_nolan" value="dg"><label for="chk_dg">dg</label></td>
                ...
                <fieldset>
                    ...
                    <p><input type="radio" name="rd_motif" value="deminfo" id="rd_deminfo" /> <label for="deminfo">Demande d'information</label></p>
                    <p><input type="radio" name="rd_motif" value="reclam" id="rd_reclam" /> <label for="reclam">Réclamation</label></p>
                    <p><input type="radio" name="rd_motif" value="satis" id="rd_satis" /> <label for="satis">Satisfaction</label></p>
                    <p><input type="radio" name="rd_motif" value="suivi" id="rd_suivi" /> <label for="suivi">Suivi de commande</label></p>
                    <p><input type="radio" name="rd_motif" value="pub" id="rd_pub" /> <label for="pub">Publicité</label></p>
                    <p><input type="radio" name="rd_motif" value="autre" id="rd_autre" /> <label for="autre">Autre...</label></p>
                ...
                <p id="controles"><input type="button" name="sub_envoyer" id="btn_envoyer" value="Envoyer votre demande de contact" /> <input type="reset" name="rst_annuler" value="Effacer les réponses" /></p>
            </form>
        </section>
